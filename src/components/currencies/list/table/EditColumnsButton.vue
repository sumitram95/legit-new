...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        { name: 'column1', title: 'Technology partners', visible: false, hideable: true },
        { name: 'column2', title: 'Governance structure', visible: false, hideable: true },
        { name: 'column3', title: 'Main motivation/goals of the AI policy', visible: false, hideable: true },
        { name: 'column4', title: 'Description', visible: false, hideable: true },
        { name: 'column5', title: 'Link to announcement', visible: false, hideable: true },
        { name: 'column5', title: 'Link to whitepaper', visible: false, hideable: true }
      ]
    }
  },
  methods: {
