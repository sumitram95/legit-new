  ...
  <b-navbar class="ui-layout-header" :class="{'isNavbarExpanded': isNavbarExpanded}" toggleable="md">
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav class="ml-auto">
        ...
        <HeaderLink class="flex-right" href="https://docs.google.com/document/d/199QtBdQwRWVHXxN5wasRBbTNTgsvmP347GsQFyR2p3o/edit" text="Whitepaper" @click="onLickClick"></HeaderLink>
