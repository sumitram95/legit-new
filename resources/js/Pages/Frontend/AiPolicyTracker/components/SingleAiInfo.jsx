...
export default function SingleAiInfo({ aiPolicyTrackerdetail }) {
    // console.log(aiPolicyTrackerdetail);
        ...
        <div className="bg-white rounded-md py-3">
            <div className="border-b-2 pb-4 px-5">
                <div>
                    <p className="font-bold text-primary text-lg">
                        {ai_policy_name ?? ''} <i className="fa-regular fa-star"></i>
                    </p>
                </div>
                <div className="flex gap-5 mt-3 text-sm">
                    <p className="text-sm text-primary">{technology_partners ?? ''}</p>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="px-5 mt-4">
                    ...
                    <p className="text-gray-600">{governance_structure ?? ''}</p>
                </div>
                <div className="px-5 mt-4">
