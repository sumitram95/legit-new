                ...
                <div className="mt-2 flex items-center gap-x-4">
                    <div className="flex items-center">
                        <input
                            ...
                            value={true}
                            checked={data.ict_training.is_conducted_training === true}
                            onChange={() =>
                                setData((prev) => ({
                                    ...prev,
                                    ict_training: {
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            name="is_conducted_training"
                            value={false}
                            checked={data.ict_training.is_conducted_training === false}
                            onChange={() =>
                                setData((prev) => ({
                                    ...prev,
                                    ict_training: {
            ...
            {data.ict_training.is_conducted_training === false && (
                <div className="sm:col-span-6 mt-4">
                    ...
                    <input
                        ...
                        value={data.ict_training.reason_for_not_conducting || ""}
                        onChange={(e) =>
                            setData((prev) => ({
                                ...prev,
                                ict_training: {
                                    ...prev.ict_training,
                                    reason_for_not_conducting: e.target.value,
                                },
                            }))
                        }
