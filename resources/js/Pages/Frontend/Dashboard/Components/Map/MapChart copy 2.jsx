...
import am4geodata_worldLow from "@amcharts/amcharts4-geodata/worldLow"; // This includes all countries
...
export function MapChart({ countrywithStatus, countryWithAiPolicies }) {
    // Only include Nepal's data
    const COLOR_MAP = {
        NP: COLORS[countrywithStatus["NP"]] || "#667A91", // Default color if status not found
    };
    ...
    useEffect(() => {
        ...
        polygonSeries.include = ["NP"]; // Only include Nepal

        // Configure series
        let polygonTemplate = polygonSeries.mapPolygons.template;
        polygonTemplate.tooltipText = "{name}";

        // Apply color to Nepal
