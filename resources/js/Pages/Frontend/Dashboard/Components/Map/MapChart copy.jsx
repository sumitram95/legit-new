...
export function MapChart() {
    useLayoutEffect(() => {
        ...
        `;
        // polygonTemplate.tooltipHTML = `
        //             <div style="white-space: nowrap; color: rgb(255, 255, 255); display: block;"><div><div className="ui-country-tooltip">
        // <div className="ui-country-tooltip_header">Russian Federation</div><div className="ui-country-tooltip_currency"><div className="ui-country-tooltip_currency-watch-flag"><button disabled="disabled" className="ui-button-without-styles ui-watch-flag"><span className="ui-icon"><svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="star" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi-star b-icon bi"><title>Have not in the watchlist</title><g><path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"></path></g></svg></span></button></div><div className="ui-country-tooltip_currency-name"><div className="ui-link-wrapper ui-country-tooltip_currency-name-link"><a href="/currency/russian_federation-digital_ruble" className="ui-link" title="Digital Ruble"> Digital Ruble </a></div></div><div className="ui-country-tooltip_currency-status-wrapper"><div className="ui-country-tooltip_currency-status Pilot">Pilot</div></div><a href="/currency/russian_federation-digital_ruble" className="ui-arrow-link ui-country-tooltip_currency-link" title="Go to page">  <span className="ui-icon"><svg viewBox="0 0 16 16" width="1em" height="1em" focusable="false" role="img" aria-label="arrow right circle" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi-arrow-right-circle b-icon bi"><title>Go to page</title><g><path fillRule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z"></path></g></svg></span></a></div></div></div></div>
        // `;
