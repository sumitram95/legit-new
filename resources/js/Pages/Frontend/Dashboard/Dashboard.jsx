                                    ...
                                    <div className="border rounded-md w-full bg-white ">
                                        ...
                                        <div className="flex justify-between mt-5 px-5">
                                            ...
                                            >
                                                ...
                                                <span>Watchlist ({bookmarkCount})</span> {/* Display bookmark count */}
                                            </LinkButton>
                                        ...
                                        <Table
                                            ...
                                            onHandleBookmark={handleBookmark} // Pass the handler to Table
                                            watchListIds={watchListIds} // Ensure this is an array of IDs
                                        />
                                    </div>
                                </div>
                            </div>
